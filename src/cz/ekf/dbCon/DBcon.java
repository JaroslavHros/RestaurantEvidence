...
public class DBcon implements AutoCloseable {
	...
	//  static  String username = "root";
	 // static  String password = "hateTOlose22";
    ...
    try
    {
        ...
        con = DriverManager.getConnection("jdbc:mysql://database-1.c2xqqvzd86ss.us-east-2.rds.amazonaws.com:3306/mydb","admin", "hateTOlose22");
