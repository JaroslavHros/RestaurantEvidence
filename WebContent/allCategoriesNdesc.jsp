...
<th scope="col">Název Kategorie <a href="allCategories.jsp">▲ </a> <a href="allCategoriesNdesc.jsp">▼ </a></th>
<th scope="col">Upravit</th>
<th scope="col">Odstránit</th>
...
<td><a href="updateC.jsp?id=<%=rs.getString("category_id") %>">Upravit</a></td>
<td><a href="DeleteServlet?id=<%=rs.getString("category_id") %>&akce=categoryDelete" onclick="return confirm('Opravdu chcete odstránit tento záznam?')">Odstranit</a></td>
<td><a href="allProdInCat.jsp?id=<%=rs.getString("category_id") %>"target = "popup" onclick = "window.open ('allProdInCat.jsp?id=<%=rs.getString("category_id") %>', 'name', ' width = 600, height = 400 ') " >Všechny produkty v kategorii</a></td>
</tr>
</tbody>
<% } %>
