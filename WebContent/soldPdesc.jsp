...
<%
String query = "select * from sellproducts order by p_name desc";
...
<tr>
<th>ID</th>
<th>Product name  <a href="soldP.jsp">▲ </a> <a href="soldPdesc.jsp">▼ </a></th>
<th>Quantity</th>
<th>Date</th>
<th>Username</th>
<th>Product ID</th>
...
<td><%=rs.getString("userName") %></td>
<td><%=rs.getString("product_id") %></td>
<td><a href="updateS.jsp?id=<%=rs.getInt("id") %>">update</a></td>
<td><a href="DeleteServlet?id=<%=rs.getInt("id") %>&akce=soldDelete" onclick="return confirm('Are you sure?')">delete</a></td>
<td><a href="InfoServlet?name=<%=rs.getString("p_name") %>&akce=stockInfo">info</a>
