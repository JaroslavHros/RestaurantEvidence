...
<h2> Upravit kategorii : <%=i%></h2>
<form  method="post" action="UpdateServlet">

<% 

 String query = "select * from category where category_id='"+i+"'";
...
<input type="hidden" name="id" value="<%=rs.getInt("category_id") %>">
<label for="p_name">Název:</label>
<input type="text" name="c_name" id="c_name" class="form-control" value="<%=rs.getString("name") %>">
</div>
...
%>
<div class="form-group">
<input type="hidden" name="akce" value="updateCat">
