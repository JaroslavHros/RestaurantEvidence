...
<h1> Upravit produkt : <%=i%></h1>
<form  method="post" action="UpdateServlet" >

<% 

 String query = "select * from product where product_id='"+i+"'";
Connection con = null;
...
<input type="text" name="p_name" id="p_name" class="form-control" value="<%=rs.getString("product_name") %>">
</div>
 <div class="form-group"> 
 <label for="info">Info:</label>
<input type="text" name="info" id="info" class="form-control" value="<%=rs.getString("info") %>">
</div>
<div class="form-group">
<label for="price">Cena:</label>
<input type="number" name="price" id="price" class="form-control" value="<%=rs.getInt("cena") %>">
</div>
<%
}
%>
...
<select name="cat_id" id="sel" class="form-control">
<%
String queryCt = "select category_id from category";
PreparedStatement pstCat = DBcon.createConnection().prepareStatement(queryCt);
...
<input type="hidden" name="akce" value="updatePro">
