...
<%
 ...
 String query = "select * from stock where id='"+i+"'";
 Connection con = null;
...
<input class="form-control" type="text" name="p_name" id="name" value="<%=rs.getString("p_name") %>">
</div>
 <div class="form-group"> 
<label for="q">Množství :</label>
<input  class="form-control" type="number" name="quantity" id="q" value="<%=rs.getString("quantity") %>">
</div>
<div class="form-group">
<label for="d">Dátum :</label>
<input class="form-control" type="date" name="date" id="d" value="<%=rs.getString("date") %>">
</div>
<div class="form-group">
<input type="submit" value="Upravit" class="btn btn-primary">
<input type="hidden" name="akce" value="updateStock">
</div>
</form>
</div>
</main>
